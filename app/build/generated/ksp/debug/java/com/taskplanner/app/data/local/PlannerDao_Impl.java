  ...
  public PlannerDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTaskItem = new EntityInsertionAdapter<TaskItem>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`title`,`description`,`scheduledHour`,`priority`,`status`,`isCompleted`,`source`,`createdAt`,`completedAt`,`endDateMillis`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getEndDateMillis() == null) {
          ...
          statement.bindLong(11, entity.getEndDateMillis());
        }
      }
    };
    ...
    this.__updateAdapterOfTaskItem = new EntityDeletionOrUpdateAdapter<TaskItem>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`description` = ?,`scheduledHour` = ?,`priority` = ?,`status` = ?,`isCompleted` = ?,`source` = ?,`createdAt` = ?,`completedAt` = ?,`endDateMillis` = ? WHERE `id` = ?";
      }
      ...
      public List<TaskItem> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TaskItem(_tmpId,_tmpTitle,_tmpDescription,_tmpScheduledHour,_tmpPriority,_tmpStatus,_tmpIsCompleted,_tmpSource,_tmpCreatedAt,_tmpCompletedAt,_tmpEndDateMillis);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public TaskItem call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new TaskItem(_tmpId,_tmpTitle,_tmpDescription,_tmpScheduledHour,_tmpPriority,_tmpStatus,_tmpIsCompleted,_tmpSource,_tmpCreatedAt,_tmpCompletedAt,_tmpEndDateMillis);
          } else {
            _result = null;
          }
          return _result;
